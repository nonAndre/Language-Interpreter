...
public class langLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FLOAT", "INT", "NAT", "POS", "DIGIT", "POSDIGIT", "BOOL", "STRING", 
			"STRCHR", "ESC", "PLUS", "MINUS", "MUL", "DIV", "MOD", "POW", "DOT", 
			"COMMA", "CONCAT", "AND", "OR", "EQQ", "NEQ", "LEQ", "GEQ", "LT", "GT", 
			"NOT", "IF", "THEN", "ELSE", "WHILE", "FOR", "SKIPP", "ASSIGN", "TYPE", 
			"RET", "SLY", "ARNOLD", "OUT", "IN", "TOSTR", "FUN", "ND", "LPAR", "RPAR", 
			"LBRAK", "RBRAK", "LBRACE", "RBRACE", "SEMICOLON", "ID", "WS"
		};
	}
